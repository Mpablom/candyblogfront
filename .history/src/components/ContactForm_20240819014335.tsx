...
const ContactForm = () => {
  return (
    <Box sx={{ padding: 4 }} className="contact-form">
      ...
      <Button variant="contained" sx={{bgcolor:"text.secondary", color:"white", ":hover":{bgcolor:"text.secondary", scale: 1.1, transform: "translateY(-2px)",transition: "all 0.2s ease-in-out"}}}>Enviar</Button>
