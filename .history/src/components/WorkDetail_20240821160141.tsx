...
const WorkDetail: React.FC<WorkDetailProps> = ({id}) => {
  ...
  return (
    <Box sx={{ padding: 4, display: 'flex', flexDirection: 'column', alignItems: 'center',backgroundImage: 'linear-gradient(45deg,#ffdde1 -20%, #ee9ca7 50%, #ffdde1 120%)', borderRadius: '20px' }}>
