...
const ContactForm = () => {
  return (
    <Box sx={{ padding: 4 }} className="contact-form">
      ...
      <Typography><a href="https://www.facebook.com/profile.php?id=100068839001840" target="_blank" rel="noreferrer"><FacebookIcon sx={{fontSize: 40, filter: "drop-shadow(2px 2px 9px rgba(0, 0, 0, 0.3))"}} color="primary"/></a></Typography>
      </Box>
    </Box>
  );
};
