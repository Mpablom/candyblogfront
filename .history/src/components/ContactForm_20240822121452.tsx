  ...
  return (
    <Box sx={{ padding: 4 }} className="contact-form">
      ...
      <Box sx={{ marginTop: 4 }}>
        ...
        <Typography><a href="https://www.facebook.com/profile.php?id=100068839001840" target="_blank" rel="noreferrer"><FacebookIcon sx={{fontSize: 40, filter: "drop-shadow(1px 1px 6px rgba(2, 2, 2, 1))"}} color="primary"/></a></Typography>
      </Box>
    </Box>
  );
};
