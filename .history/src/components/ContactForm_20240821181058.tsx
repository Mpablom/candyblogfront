...
const ContactForm = () => {
  return (
    <Box sx={{ padding: 4 }} className="contact-form">
      ...
      <TextField fullWidth sx={{backgroundColor: 'white', borderRadius: 5, boxShadow: 2,borderColor: 'secondaty.main'}} label="Nombre" margin="normal" />
      <TextField fullWidth sx={{backgroundColor: 'white', borderRadius: 5, boxShadow: 2,borderColor: 'secondaty.main'}} label="Email" margin="normal" />
      <TextField fullWidth sx={{backgroundColor: 'white', borderRadius: 5, boxShadow: 2,borderColor: 'secondaty.main'}} label="Mensaje" multiline rows={4} margin="normal" />
