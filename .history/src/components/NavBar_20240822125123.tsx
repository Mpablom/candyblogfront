      ...
      <Toolbar sx={{ justifyContent: "space-between", minHeight: "100%" }}>
        <div className="logo-container">
          <img
            ...
            alt="logo"
            className="logo"
            style={{ height: isScrolled ? "100px" : "250px", transition: "height 1.1s ease-in-out", filter: "drop-shadow(0px 0px 5px #292828)" }}
          />
        </div>

        <Box sx={{ display: { xs: "none", sm: "block" }}}>
          <Button color="inherit" onClick={handleScrollToContact} className="btn-nav" sx={{ fontWeight: "500", fontSize: "1.2em" }}>
            Contactos
          </Button>
          <Button color="inherit" onClick={handleScrollToWorks} className="btn-nav" sx={{ fontWeight: "500", fontSize: "1.2em" }}>
            Nuestros Trabajos
          </Button>
        </Box>
