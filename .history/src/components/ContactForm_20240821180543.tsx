...
const ContactForm = () => {
  return (
    <Box sx={{ padding: 4 }} className="contact-form">
      ...
      <TextField fullWidth sx={{backgroundColor: 'white', borderRadius: 2, boxShadow: 5}} label="Nombre" margin="normal" />
      <TextField fullWidth sx={{backgroundColor: 'white', borderRadius: 2, boxShadow: 5}} label="Email" margin="normal" />
      <TextField fullWidth sx={{backgroundColor: 'white', borderRadius: 2, boxShadow: 5}} label="Mensaje" multiline rows={4} margin="normal" />
