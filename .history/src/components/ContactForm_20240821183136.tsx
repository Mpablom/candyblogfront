...
const ContactForm = () => {
  return (
    <Box sx={{ padding: 4 }} className="contact-form">
      <Typography variant="h4" gutterBottom sx={{ fontSize: "4em", fontFamily:"Great Vibes, cursive", fontWeight:"400", fontStyle:"normal", filter: "drop-shadow(0.5px 0.5px 0.5px #292828)"}}>Contacto</Typography>
      ...
      <Box sx={{ marginTop: 4 }}>
        ...
        <Typography><a href="https://www.facebook.com/profile.php?id=100068839001840"><FacebookRounded sx={{ fontSize: 30, color: "rgb(68, 68, 192)", filter: "drop-shadow(0.5px 0.5px 0.5px #292828)" }}/></a></Typography>
      </Box>
    </Box>
  );
};
