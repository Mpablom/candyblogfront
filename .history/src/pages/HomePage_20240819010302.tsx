...
const HomePage = () => {
  return (
    ...
    >
      <Navbar />
      <section id="home-section" style={{height: '100vh', backgroundImage: `url(${works[6].image})`, backgroundSize: 'cover', backgroundPosition: 'center', boxShadow:'none', backdropFilter: 'blur(5px)'}}>
