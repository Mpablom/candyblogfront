  ...
  return (
    ...
    >
      ...
      <section id="home-section" style={{ marginTop: "150px" }}>
        <Typography variant="h1" gutterBottom sx={{ fontSize: "9em", fontFamily:"Great Vibes, cursive", fontWeight:"100", fontStyle:"normal", mt: 4 }}>Bienvenidos a nuestra página web</Typography>
        <p>
