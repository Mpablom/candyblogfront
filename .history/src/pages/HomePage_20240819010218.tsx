  ...
  return (
    ...
    >
      ...
      <section id="home-section" style={{height: '100vh', backgroundImage: `url(${works[6].image})`, backgroundSize: 'cover', backgroundPosition: 'center', boxShadow:'none'}}>
        ...
        <p style={{textAlign: 'center', paddingLeft: '20px', paddingRight: '20px', fontSize: '20px', backdropFilter: 'blur(5px)'}}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora nemo culpa optio fugit velit, consequuntur animi numquam inventore minus molestiae, modi quia aut hic accusamus voluptates ratione dicta illum distinctio?
