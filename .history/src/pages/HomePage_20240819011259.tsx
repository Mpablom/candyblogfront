  ...
  return (
    ...
    >
      ...
      <div className="blur" style={{height: '100vh', boxShadow:'none',backgroundImage: `url(${works[6].image})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
          <section id="home-section" style={{ backdropFilter: 'blur(5px)', height: '100%', boxShadow:'none'}}>
          <h1>Bienvenido a Nuestra Página</h1>
          <p style={{textAlign: 'center', paddingLeft: '20px', paddingRight: '20px', fontSize: '20px', color: 'white'}}>
