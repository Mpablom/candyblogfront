...
const HomePage = () => {
  return (
    ...
    >
      <Navbar />
      <section id="home-section" style={{height: '100vh'}}>
        <h1>Bienvenido a Nuestra Página</h1>
        <p style={{textAlign: 'center', paddingLeft: '20px', paddingRight: '20px', fontSize: '20px', backgroundImage: 'linear-gradient(to right, #f12711, #f5af19)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora nemo culpa optio fugit velit, consequuntur animi numquam inventore minus molestiae, modi quia aut hic accusamus voluptates ratione dicta illum distinctio?
