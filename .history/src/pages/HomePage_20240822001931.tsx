  ...
  return (
    ...
    >
      ...
      <section id="home-section" style={{ marginTop: "150px" }}>
        <Typography variant="h1" gutterBottom sx={{ fontSize: "9em", fontFamily:"Great Vibes, cursive", fontWeight:"400", fontStyle:"normal", mt: 4, filter: "drop-shadow(10px 10px 8px #292828)" }}>Bienvenido a nuestra página</Typography>
        <p>
