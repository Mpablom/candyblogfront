...
const HomePage = () => {
  return (
    ...
    >
      <Navbar />
      <div className="blur" style={{height: '100vh', boxShadow:'none',backgroundImage: `url(${works[6].image})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
          <section id="home-section" style={{ backdropFilter: 'blur(30px)', height: '100%', boxShadow:'none'}}>
          <h1>Bienvenido a Nuestra Página</h1>
          <p style={{textAlign: 'center', paddingLeft: '200px', paddingRight: '200px', fontSize: '20px', color: 'black'}}>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora nemo culpa optio fugit velit, consequuntur animi numquam inventore minus molestiae, modi quia aut hic accusamus voluptates ratione dicta illum distinctio?
              ...
              Culpa autem aspernatur, quis, minus nobis illum vel libero vitae aut porro, ipsa a quia dolores veniam beatae dignissimos quisquam corporis laudantium iste eos sed neque velit. Asperiores, omnis commodi!
          </p>
        </section>
      </div>
