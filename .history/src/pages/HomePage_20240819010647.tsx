...
const HomePage = () => {
  return (
    ...
    >
      <Navbar />
      <div className="blur" style={{ boxShadow:'none',backgroundImage: `url(${works[6].image})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
          <section id="home-section" style={{height: '100vh', backdropFilter: 'blur(10px)'}}>
