...
const HomePage = () => {
  ...
  const handleWhatsAppClick = () => {
    window.open("https://wa.me/tu-numero-de-whatsapp", "_blank"); // Reemplaza "tu-numero-de-whatsapp" por tu número
  };
  ...
  return (
    ...
    >
      ...
      <section id="works-section" style={{ marginTop: "60px", padding: "80px" }}>
        <Typography variant="h4" gutterBottom sx={{mb: 10, fontSize: "4em", fontFamily:"Great Vibes, cursive", fontWeight: "400", fontStyle:"normal"}}>Trabajos Realizados</Typography>
      ...
      <div style={{ position: 'fixed', bottom: 20, right: 20, display: 'flex', flexDirection: 'column', gap: '10px' }}>
        <IconButton
          ...
          sx={{ bgcolor: '#25D366', color: '#fff', '&:hover': { bgcolor: '#128C7E' }, filter: "drop-shadow(3px 3px 30px rgba(0, 0, 0, 0.6))" }}
        >
          <WhatsAppIcon />
        </IconButton>
        <IconButton
          ...
          sx={{ bgcolor: '#000', color: '#fff', '&:hover': { bgcolor: '#555' }, filter: "drop-shadow(1px 1px 3px rgba(0, 0, 0, 0.6))" }}
        >
          <ArrowUpwardIcon />
        </IconButton>
      </div>
