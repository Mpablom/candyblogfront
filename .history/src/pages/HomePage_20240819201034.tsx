  ...
  return (
    ...
    >
      ...
      <section id="works-section" style={{ marginTop: "60px", padding: "80px" }}>
        <Typography variant="h4" gutterBottom sx={{mb: 20, fontSize: "4em", fontFamily:"Great Vibes, cursive", fontWeight: "400", fontStyle:"normal"}}>Trabajos Realizados</Typography>
